        ...
        sections: [
          {
            ...
            fields: {
              eyebrow: 'Career',
              heading: `${name}'s Resume`,
              subtitle: 'Professional background and career history',
              actions: [
                { label: 'Download PDF', href: '/output/resume', style: 'gold' },
                { label: 'Contact Me', href: '#contact', style: 'outline-light' },
              ],
            },
          },
          {
              ...
              roles: [
                {
                  ...
                  current: true,
                  description: 'One-paragraph summary of the work and outcomes.',
                },
                {
                  title: 'Previous Role',
                  company: 'Company Name',
              ...
              skills: [
                {
                  ...
                  items: [
                    { name: 'Skill One', level: 'expert', years: '' },
                    { name: 'Skill Two', level: 'proficient', years: '' },
                  ],
                },
              ],
            },
