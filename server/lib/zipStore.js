// Minimal standards-compliant ZIP writer using the STORE method. This keeps
// retention archives dependency-free and preserves the original bytes.
...
export function createZip(files) {
  ...
  for (const file of files) {
    const name = Buffer.from(file.name.replace(/[\\/:*?"<>|]/g, '_'));
