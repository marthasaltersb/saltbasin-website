...
//  - 'classic' — no docked-panel build yet; dollying in hands off to the
//                Classic Tools view (the existing AdminShell/MemberDashboard,
//                mounted unchanged inside WorldShell) at that exact tab, via
//                the same `sb-admin-switch-tab` window event AdminShell
//                already listens for. Nothing here is a dead/stubbed link —
//                every island opens real, working functionality.
