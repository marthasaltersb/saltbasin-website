...
const S = {
  ...
  navItem: (active, visited) => ({
    ...
    background: active ? 'var(--sb-navy, #1b2a3b)' : visited ? 'rgba(0,0,0,0.05)' : 'transparent',
    color: active ? 'white' : visited ? 'var(--sb-navy, #1b2a3b)' : '#888',
  ...
  riverViewport: { position: 'relative', borderRadius: 12, padding: '2.5rem 1.5rem', marginBottom: '1rem', textAlign: 'center', overflow: 'hidden', background: 'linear-gradient(135deg, #14202e, #1b2a3b 55%, #2a3f57)' },
  riverGlow: { position: 'absolute', inset: 0, background: 'radial-gradient(circle at 50% 40%, rgba(196,132,58,0.35), transparent 60%)' },
  riverLabel: { position: 'relative', color: 'white', fontSize: '1.1rem', fontWeight: 700, letterSpacing: '0.02em' },
  riverSub: { position: 'relative', color: 'rgba(255,255,255,0.75)', fontSize: '0.78rem', marginTop: 6 },
  ...
  nextBtn: { padding: '0.6rem 1.4rem', borderRadius: 8, border: 'none', background: 'var(--sb-gold, #c4843a)', color: 'white', fontSize: '0.85rem', fontWeight: 600, cursor: 'pointer', marginTop: '0.5rem' },
